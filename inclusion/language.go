...
var inclusiveFilters = []InclusiveFilter{
	...
	{Filter: "slave", Reply: `If you are referring to a data replication strategy, please consider a term such as ""follower"" or ""replica"". You can read more information about it in https://www.selfdefined.app/definitions/master-slave/`},
