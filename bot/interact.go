		...
		case slack.InteractionTypeDialogSubmission:
			...
			case "job_submission":
				...
				if err != nil || maxSalary == 0 {
					validationErrors["max_salary"] = "The Salary Max field cannot be empty."
				}
				...
				if minSalaryStr := strings.TrimSpace(message.Submission["max_salary"]); minSalaryStr != "" {
					...
					if err != nil || maxSalary == 0 {
						validationErrors["min_salary"] = "The Salary Min field should contain be a valid number."
					}
				}
