...
// Handler metadata (all optional except `handle` function)
var name = "example-handler";
var description = "Example handler that demonstrates all available features";
var channels = ["playground", "offtopic-*"]; // Matches 'playground' and any channel starting with 'offtopic-'
var priority = 100; // Lower runs first (default: 100)
var enabled = false; // Set to true to enable this handler
var timeout = 5000; // Execution timeout in milliseconds (default: 5000)
